    ...
    <div className='form'>
      ...
      <div className='personal-info form-el'>
        <form action='' className='personal-info-form form-component'>
          ...
          >
            <i className='fa-solid fa-chevron-down'></i> Personl Info
          </h2>
          <div
            className={`form-content ${isPersonalInfoOpen ? 'show' : 'hidden'}`}
          >
      ...
      <div className='nationality-details form-el'>
        <form action='' className='nationality-details-form form-component'>
          <h2
            className='form-title'
            onClick={() => handleNatDet(isNatDetailsOpen)}
          >
            <i className='fa-solid fa-chevron-down'></i> Nationality Details
          </h2>
          <div
            className={`form-content ${isNatDetailsOpen ? 'show' : 'hidden'}`}
          >
            <p className='form-element'>
              <label htmlFor='nationality'>Nationality *</label>
              <br />
              <select name='nationality' id='nationality' className='w-100'>
      ...
      <div className='employment-details form-el'>
        <form action='' className='employment-details-form form-component'>
          <h2 className='form-title' onClick={() => handleEmpDet(isEmpDetOpen)}>
            <i className='fa-solid fa-chevron-down'></i> Employment Details
          </h2>
          <div className={`form-content ${isEmpDetOpen ? 'show' : 'hidden'}`}>
            <p className='form-element'>
      ...
      <div className='residential-details form-el'>
        <form action='' className='personal-info-form form-component'>
          <h2 className='form-title' onClick={() => handleResDet(isResAddOpen)}>
            <i className='fa-solid fa-chevron-down'></i> Residential address
          </h2>
          <div className={`form-content ${isResAddOpen ? 'show' : 'hidden'}`}>
            <p className='form-element'>
            ...
            <p className='form-element'>
              ...
              <br />
              <select name='postal-code' id='postal-code' className='w-100'>
            ...
            <p className='form-element'>
              ...
              <br />
              <input type='text' name='address-line-3' id='address-line-3' />
            </p>
          </div>
        </form>
        <div className='border'></div>
